...
- Une page contenant une carte affichant les POI "Remonter le temps" de l'application Cartes IGN sur le fond WMTS "Plan IGN". Les POI sont cliquables, affichant une pop-up avec les infos des propriétés `commune`, `département`, `accroche`, `titre` et `description` mises en forme, et un lien vers le site [https://remonterletemps.ign.fr/comparer/](https://remonterletemps.ign.fr/comparer/) ouvrant directement la bonne vue (par exemple, https://remonterletemps.ign.fr/comparer/?lon=1.703952&lat=47.996355&z=14&layer1=ORTHOIMAGERY.ORTHOPHOTOS.1950-1965&layer2=ORTHOIMAGERY.ORTHOPHOTOS&mode=vSlider). Données disponibles dans le dossier data [data/poi_rlt.json](data/poi_rlt.json).
